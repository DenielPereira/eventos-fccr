...
<body class="bg-white">
    ...
    window.onload = function() {
        ...
        swal({
            ...
            text: "O evento será excluído e não vai mais poder ser visto por ninguém!",
            icon: "warning",
            ...
            .then((willDelete) => {
                if (willDelete) {
                    swal("Puf! O evento foi excluído :)", {
                    icon: "success",
                })
                    .then((value) => {
                    ...
                    swal("O evento está a salvo, ufa! :)")
                    .then((value) => {
...
<div class="hidden d-none">
    <form class="w-80 mx-auto" id="delete-event-form" action="../src/controllers/desativarevento.php" method="POST">
